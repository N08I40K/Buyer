...
import ru.n08i40k.buyer.commands.subcommands.AdminCommand;
import ru.n08i40k.buyer.commands.subcommands.OpenCommand;
import ru.n08i40k.buyer.commands.subcommands.LocaleCommand;
...
public class MainCommand extends Command {
    ...
    public MainCommand() {
        super(BuyerPlugin.PLUGIN_NAME_LOWER, "Main " + BuyerPlugin.PLUGIN_NAME + " command.", "/" + BuyerPlugin.PLUGIN_NAME_LOWER, List.of());
        ...
        subcommands.add(new OpenCommand(null));
